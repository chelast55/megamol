...
mmCreateModule("ParticleThinner","::ParticleThinner_1")
...
mmCreateCall("MultiParticleDataCall","::renderer::getdata","::ParticleThinner_1::outData")
mmCreateCall("CallLight","::renderer::lights","::distantlight::deployLightSlot")
mmCreateCall("MultiParticleDataCall","::ParticleThinner_1::indata","::data::getdata")
...
for _, dataset_path in ipairs(DATASETS) do
	...
	for _, thinning_factor in ipairs(THINNING_FACTORS) do
		mmSetParamValue("::ParticleThinner_1::thinningFactor", thinning_factor)
		mmRenderNextFrame()
		...
		for _, height in ipairs(RESOLUTIONS) do
			...
			for i=1,CAMERA_ANGLE_COUNT do
				...
				test_case_name = GENERAL_TEST_CASE_NAME .. ":" .. thinning_factor .. "|" .. dataset_name .. "|" .. height .. "p" .. "|" .. "cam" .. i
